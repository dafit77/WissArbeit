...
* Danach wurden die [Funktionen](Aufgabe_2_Skript_1.R) und [Hilfsfunktionen](Aufgabe_2_Skript_2.R) programmiert.
* Darauf folgend haben wir den [berichtigten Datensatz](titanic_Berichtigt.csv) mit den [Funktionen](Aufgabe_2_Skript_1.R) analysiert und die analyse in [Aufgabe_4.R](Aufgabe_4.R) festgehalten.
* Zum Schluss wurden die Ergebnisse im [Forum](https://github.com/dafit77/WissArbeit/discussions/42) festgehalten.
